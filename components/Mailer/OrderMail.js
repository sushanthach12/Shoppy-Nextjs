            ...
            <div class="relative lg:min-h-full">
                <div class="max-w-2xl mx-auto py-16 px-4 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8 lg:py-32 lg:grid lg:grid-cols-2 lg:gap-x-8 xl:gap-x-24">
                    <div class="lg:col-start-2">
                        ...
                        <p class="mt-2 text-base text-gray-500">We appreciate your order, were currently processing it. So hang tight and well send you confirmation very soon!</p>
                        ...
                        <dl class="mt-16 grid grid-cols-2 gap-x-4 text-sm text-gray-600 border-b pb-10 border-gray-200">
                            <div>
