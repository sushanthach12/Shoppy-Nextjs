...
const Signup2 = () => {
    return (
        <div className='min-h-screen'>
            <section class="relative bg-white overflow-hidden px-3 mx-2">
                {/* <img class="absolute left-0 top-0" src="flaro-assets/images/sign-in/gradient.svg" alt="Shoopy" /> */}
                ...
                <div class="relative z-10 flex flex-wrap -m-8  min-h-screen">
                    <div class="w-full h-full md:w-1/2 px-8 bg-no-repeat bg-cover" style={{"backgroundImage" : "url(/images/backimg.jpg)"}}>
                        <div class="container px-4 mx-auto">
                            <div class="flex flex-wrap">
                                <div class="w-full">
                                    <div class="md:max-w-lg mx-auto pt-20 md:pb-32 ">
                                        <div class=" flex flex-col justify-between items-center py-20" >
                                            <h2 class=" text-6xl  md:text-7xl font-bold font-heading tracking-px-n leading-tight">Sign in and start saving time today.</h2>
                                            {/* <div>

                                            <Image className='w-full h-full' src="/images/p2.png" alt="" width={200} height={200} />
                                            </div> */}

                                            {/* <Image className='l-0' src="/images/p1.png" alt="" width={300} height={300} /> */}
                                        </div>
                    ...
                    <div class="w-full md:w-1/2 px-8 bg-gray-100">
                        <div class="px-4 py-28 flex flex-col justify-center bg-blueGray-100 h-full">
                                ...
                                <div class="flex flex-wrap justify-center -m-2">
                                    <div class="w-auto p-2">
                                        <button class="flex items-center p-4 bg-white hover:bg-gray-50 border rounded-lg transition ease-in-out duration-200">
                                            <Image class="mr-3" src="/google.svg" alt="google" width={20} height={20} />
                                            <span class="font-semibold leading-normal">Sign in with Google</span>
                                        </button>
                                    </div>
                                    <div class="w-auto p-2">
                                        <button class="flex items-center p-4 text-white bg-indigo-600 hover:bg-gray-50 border rounded-lg transition ease-in-out duration-200">
                                            <Image class="mr-3" src="/fb.svg" alt="Facebook" width={20} height={20} />
