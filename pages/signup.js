...
const Signup = ({ setKey, setUser }) => {
  ...
  const { handleSignup } = UserContext
            ...
            <div className="w-full px-4">
              <div className="relative mx-auto max-w-[525px] overflow-hidden rounded-lg bg-gray-50 py-6 px-10 text-center sm:px-12 md:px-[60px]">
                <div className="mb-6 text-center md:mb-16">
                  ...
                  <Link className="text-4xl font-bold text-gray-800 transition-colors duration-300 transform dark:text-orange-300 lg:text-3xl hover:text-gray-700 dark:hover:text-gray-300 tracking-widest" href="/">Shoppy.</Link>
                </div>
                ...
                <form autoComplete='off' onSubmit={handleSubmit}>
                  <div className="mb-6">
                    <input
                      ...
                      type="text"
                      placeholder="Name"
                      className="bordder-[#E9EDF4] w-full rounded-md border bg-[#FCFDFE] py-3 px-5 text-base text-body-color placeholder-[#ACB6BE] outline-none focus:border-primary focus-visible:shadow-none" autoComplete='false'
                  ...
                  <div className="mb-6">
                    <input
                      ...
                      className="bordder-[#E9EDF4] w-full rounded-md border bg-[#FCFDFE] py-3 px-5 text-base text-body-color placeholder-[#ACB6BE] outline-none focus:border-primary focus-visible:shadow-none" autoComplete='new-password'
                ...
                {/* <p className="mb-6 text-base text-indigo-400 font-semibold">or Login with</p>
                <ul className="-mx-2 mb-12 flex justify-between">
                  ...
                  <li className="w-full px-2">
                    <a
                      href="#"
                      className="flex h-11 items-center justify-center rounded-md bg-white hover:bg-opacity-90"
                    >
                      <Image src={"/google.svg"} width={19} height={19} alt='google'>
