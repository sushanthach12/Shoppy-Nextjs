  ...
  return (
    <div className='min-h-screen'>
        <div class="flex items-center justify-center min-h-screen bg-gray-100 py-10">
            <div class="w-3/5 bg-white shadow-lg rounded-md">
                <div class="flex justify-between p-4">
                    <div>
                        <h1 class="text-3xl italic font-extrabold tracking-widest text-orange-400">Larainfo</h1>
                    ...
                    <div class="p-2">
                        <ul class="flex">
                            ...
                            {/* <li class="flex flex-col p-2 border-l-2 border-orange-200">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-blue-600" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="w-full h-0.5 bg-orange-500"></div>
                <div class="flex justify-between p-4">
                    <div>
                    ...
                    <div class="border-b border-gray-200 shadow">
                        <table class="">
                            ...
                            <tbody class="bg-white">
                                ...
                                <tr class="text-white bg-gray-800 py-2">
                                    <th colspan="3"></th>
                ...
                <div class="flex justify-between p-4">
                    <div>
                        ...
                        <ul class="text-xs list-disc list-inside pt-2">
                    ...
                    {/* <div class="p-4">
                        <h3>Signature</h3>
                        <div class="text-4xl italic text-orange-500">AAA</div>
                    </div> */}
                </div>
                <div class="w-full h-0.5 bg-orange-500"></div>
